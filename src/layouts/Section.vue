    ...
    <section>
        <div class="bg-white my-48 px-5 lg:hidden">
            ...
            <div class="mt-20 mb-32">
                ...
                ure veniam dignissimos ab illo? Saepe earum optio dolorem ea, nulla eius,
                explicabo molestias nihil, aut eaque distinctio. Magnam, tenetur?
                </P>
            </div>
        ...
        <div class="hidden lg:block">
            <div class="mx-20">
                ...
                <div class="flex justify-between">
                    <h1 class="font-thin text-5xl">OUR CREATIONS</h1>
                    <button class="tracking-widest text-xl font-bold border-2 border-gray-900 px-14 py-5">SEE ALL</button>
                </div>
